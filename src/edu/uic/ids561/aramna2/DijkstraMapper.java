...
public class DijkstraMapper extends MapReduceBase implements Mapper<LongWritable, Node, LongWritable, Node> {
	...
	public void map(LongWritable key, Node value,
			...
			if( value.color.equalsIgnoreCase("GRAY") ){
				...
				Dijkstra.GrayCounter.COUNTER --; // Decrease the counter value by 1
				value.color = "BLACK";
